...
def test_padding_oracle(ct_hex):
    """Test if ciphertext has valid padding - returns True if valid, False if invalid"""
    try:
        ct = unhexlify(ct_hex)
        decrypt(ct)
        return True
...
def menu():
    ...
    print('4. Test padding oracle')
    print('5. Keluar dari dapur')
